                        ...
                        <div class="row component-group">
                            ...
                            <div class="col-xs-12 col-md-10">
                                <fieldset class="component-group-list">
                                    ...
                                    <config-textbox-number v-show="search.general.backlogBatchSize > 0" :min="0" :step="1" v-model.number="search.general.backlogBatchRefillThreshold" label="Backlog batch refill threshold" id="backlog_batch_refill_threshold" :explanations="['queue the next batch as soon as this many (or fewer) backlog searches are still pending (default: 2)']" />
