...
export default {
    ...
    computed: {
        ...mapState({
            ...
            indexerDefaultLanguage: state => state.config.general.indexerDefaultLanguage,
    ...
    methods: {
        ...
        openAddNewShow(curDirIndex, unattended = false) {
            const { addShowComponents, filteredDirList, presetShowOptions, promptForSettings, indexerDefaultLanguage } = this;
            ...
            const providedInfo = {
                ...
                showDir: curDir.path,
                indexerId: 0,
                indexerLanguage: indexerDefaultLanguage || null,
